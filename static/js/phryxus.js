    ...
    contactForm = {
        init: function() {
            ...
            $("#contacto").submit(function(){
                ...
                $("#contacto").append('<input type="hidden" value="TRUE" id="is_ajax" name="is_ajax" />');
                $('#send').off();
                $.ajax({
                    type: "POST",
                    url: "/contacto/send",
                    ...
                    success: function(json){
                        $("#manifesto").append('<div class="grid_6 push_1 success" style="margin-bottom: 40px; display: none;"> Mensaje enviado, nos pondremos en contacto con la mayor brevedad posible. </div>');
                        $('.success').slideToggle().delay('3000').slideToggle('400', function() { $(this).detach() } );
                    ...
                    error: function(json){
                        $("#manifesto").append('<div class="grid_6 push_1 error" style="margin-bottom: 40px; display: none;"> ' + json.responseText + ' </div>');
                        $('.error').slideToggle().delay('3000').slideToggle('400', function() { $(this).detach() } );
                        $("body").css("cursor", "default");
                        $('#send').click(function(){
                            $("#contacto").submit();
                        });
