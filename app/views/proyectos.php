    <div id="main" role="main" class="container_12">
		<div id="proyectos" class="grid_8 push_2">
			...
			<div class="flecha inactive" data-dir="izda" id="flechaIzda" style=""></div>
            ...
            foreach($files as $file) { 	?>
				<div id="proyecto<?= $i ?>" class="grid_3 <?php echo (($i == 1 || $i%4 == 1) ? 'alpha' : (($i%4 == 0) ? 'omega' : '')); ?> proyecto">
			...
			<div class="flecha inactive" data-dir="dcha" id="flechaDcha" style=""></div>
			<span class="linea baja grid_12 pull_2 alpha omega" style=""></span>
			<div class="clear"></div>
			<div id="descripcion" class="grid_12 pull_2" style="">
			</div>
			<div id="indice" class="grid_12 pull_2" style="">
				<ul></ul>
			</div>
		</div>
    </div>
